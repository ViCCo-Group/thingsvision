...
- a few custom models trained on [Ecoset](https://www.pnas.org/doi/10.1073/pnas.2011417118) rather than ImageNet (e.g., VGG-16, Resnet50, Inception_v3 and Alexnet) or trained on ImageNet and fine-tuned on [SalObjSub](https://cs-people.bu.edu/jmzhang/sos.html) (AlexNet)
