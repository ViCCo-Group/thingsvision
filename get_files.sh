...
URLS=(
	...
	"https://raw.githubusercontent.com/ViCCo-Group/THINGSvision/master/data/files/item_names.tsv"
	"https://raw.githubusercontent.com/ViCCo-Group/THINGSvision/master/data/files/things_concepts.tsv"
)
